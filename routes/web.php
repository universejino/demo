...
Route::get('/', function () {
    ...
    Route::get('/admin/not_allowed', 'App\Http\Controllers\CommonController@notAllowed');

    Route::group(['admin/middleware' => ['auth']], function() {
    Route::get('/admin/dashboard', 'App\Http\Controllers\DashboardController@dashboard');
    Route::post('/admin/add_roles', 'App\Http\Controllers\RolesController@addManageRolesAction');
    Route::get('/admin/permissions/{id}', 'App\Http\Controllers\RolesController@managePermissions');
