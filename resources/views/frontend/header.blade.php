<header class="main-header clearfix" data-sticky_header="true">
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-8 col-sm-12">
               <p>
                  <span><i class="fa fa-location-arrow"></i> <strong>Address: </strong>  Maamoodu,K K Dt, Tamil Nadu-629161 India</span>
                  <span>&nbsp;<i class="fa fa-phone"></i> <strong>Call Us:</strong> 844 842 5409</span>
               </p>
            </div>
            <div class="col-md-4col-sm-12 row">
			   ...
			   <div class="btn-group input-group-lg mb-3 top-bar-social">
				<button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown">
				Languages
				</button>
				<ul class="dropdown-menu">
				<li class="dropdown-item"><a href="#">English</a></li>
				<li class="dropdown-item"><a href="#">Tamil</a></li>
				</ul>
				</div>
 </div>
            </div>
   ...
   <!--  end .top-bar  -->
   <section class="header-wrapper navgiation-wrapper fixed-nav-bar">
      <div class="navbar navbar-default">
         <div class="container">
            <div class="navbar-header">
               ...
               <a class="logo" href="index.html"><img alt="" src="{!! asset('frontend/images/logo1.png') !!}"></a>
            </div>
